...
<li class="nav-item">
    ...
    <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
        <div class="bg-white py-2 collapse-inner rounded">
            ...
            <a class="collapse-item" href="<?php echo base_url('/index.php/pasien/index') ?>">Data Pasien</a>
            <a class="collapse-item" href="<?php echo base_url('/index.php/pasien/jadwal_praktek') ?>">Jadwal Antrian Praktek</a>
        </div>
    </div>
</li>
